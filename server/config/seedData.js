...
const initialStays = [
  {
    ...
    price: 1500,
   images: [
  "/images/stay1/property_1_img1.png",
  "/images/stay1/property_1_img2.png",
  "/images/stay1/property_1_img3.png",
  "/images/stay1/property_1_img4.png",
  "/images/stay1/property_1_img5.png",
],
...
const seedStays = async () => {
  ...
  if (count > 0) {
    console.log("Stays already exist");
    return;
  }

  await StayModel.insertMany(initialStays);
